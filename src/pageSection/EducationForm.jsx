        ...
        {educationList.map((edu, index) => (
          <div key={index} className="space-y-6 border-b pb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-1">Institution Location</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-1">
                  {edu.current ? 'End Date (Expected)' : 'End Date'}
                </label>
                <input
                  type="month"
                  value={edu.endDate}
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label className="text-sm text-gray-600">I am currently studying here</label>
            </div>
          </div>
        ))}
